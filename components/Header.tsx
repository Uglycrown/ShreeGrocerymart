  ...
  return (
    <header className="sticky top-0 z-50 bg-yellow-400 shadow-md">
      <div className="container mx-auto px-1">
        ...
        <div className="hidden md:flex items-center justify-between py-4">
          ...
          <div className="flex-1 max-w-2xl mx-8" ref={searchRef}>
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border-2 border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white bg-white"
                autoComplete="off"
              />
          ...
          <div className="hidden md:flex items-center gap-6">
            {user ? (
              ...
              <Link href="/login" className="flex items-center gap-2 text-gray-900 hover:text-gray-700">
                <User className="w-5 h-5" />
                <span>Login</span>
              </Link>
            )}
            
            <Link href="/wishlist" className="relative text-gray-900 hover:text-gray-700 transition">
            ...
            <Link href="/cart" className="relative flex items-center gap-2">
              ...
              <div>
                <div className="text-xs text-gray-800">My Cart</div>
        ...
        <div className="bg-white border-t-2 border-yellow-500">
          <div className="container mx-auto px-1">
            <div className="flex items-center gap-6 py-3 overflow-x-auto scrollbar-hide">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-yellow-100 flex items-center justify-center group-hover:bg-yellow-400 transition-colors">
                  <ShoppingCart className="w-5 h-5 text-gray-900 group-hover:text-gray-900" />
                </div>
              ...
              {categories.map((category) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-yellow-100 flex items-center justify-center group-hover:bg-yellow-400 transition-colors">
                      <Icon className="w-5 h-5 text-gray-900 group-hover:text-gray-900" />
                    </div>
                    <span className="text-xs font-medium text-gray-700 group-hover:text-gray-900 transition-colors text-center max-w-[80px]">
                      {category.name}
                    </span>
                  </Link>
                )
