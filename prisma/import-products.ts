 ...
 * 
 * Usage: npx ts-node prisma/import-products.ts
 * 
 * Reads from: Product Name.xlsx in the project root
 */
...
async function importProducts() {
    ...
    const products: ProductRow[] = XLSX.utils.sheet_to_json(worksheet)
    ...
    for (const product of products) {
        try {
            ...
            if (categoryName.includes('>')) {
                // Handle hierarchical categories like "Grocery > Food > Snacks"
